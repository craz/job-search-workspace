...
Исторический снимок исходного монолита использовал SQLite migrations `001`–`004`.
Канонический владелец нормализованной схемы — Core на PostgreSQL 17.
Новая установка создаёт пустую PostgreSQL штатными Alembic-миграциями.
...
SQLite integer IDs нельзя обещать как публичный контракт.
