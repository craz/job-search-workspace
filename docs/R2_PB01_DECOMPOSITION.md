...
**R2.1.2:** **OWNER ACCEPTED · COMPLETE · PUSHED** (HH read-only resume detail extract)  
...
| **R2.1.2** | HH read-only extracts resume content | **OWNER ACCEPTED · COMPLETE · PUSHED** |
| **R2.1.3** | First end-to-end manual sync | **READY FOR OWNER ACCEPTANCE** |
