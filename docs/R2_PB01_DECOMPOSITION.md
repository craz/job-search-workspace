...
|---|---|---|
| **R2.1.1** | Core stores immutable ResumeVersion | **NOT STARTED** |
...
Do **not** start R2.1.1 until owner explicitly says so after this docs acceptance.
