...
3. Нажми **«Войти в HeadHunter»**. Должна открыться вкладка входа
   (обычно http://127.0.0.1:6080/). Если вкладка не появилась — разрешите
   всплывающие окна для Job Search и нажмите кнопку ещё раз.
