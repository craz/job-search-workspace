...
**Workspace HEAD:** local R2.1.1 (ahead; Core submodule local)  
**Web submodule HEAD:** `7bc0bd5`  
**HH submodule HEAD:** `5163196`  
**Core submodule HEAD:** local R2.1.1 (unpushed)  
**Ветка:** `main`
...
| **R2** | R2.1 DECOMPOSITION **OWNER ACCEPTED**; **R2.1.1 READY FOR OWNER ACCEPTANCE**; R2.1.2+ **NOT STARTED** |
...
- **«Го»** после ACCEPT R2.1.1 = старт только **R2.1.2** (HH read-only content extract).
- Или если скажешь **push** — push Core + workspace R2.1.1 baseline.
- R2.2+ / Scoring — **не** из «го».
