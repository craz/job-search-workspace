...
| Область | Статус |
|---|---|
| **R2** | **R2.1–R2.2.A COMPLETE · PUSHED**; **R2.3 architecture READY FOR OWNER REVIEW** (impl NOT STARTED); R2.4+ **NOT STARTED** |
...
- **«Го»** = `ACCEPT` R2.3 architecture (или замечания к design/decomposition).
- R2.3 implementation — **не** начинать до ACCEPT architecture.
- R2.4+ — **не** начинать до завершения R2.3 foundation.
