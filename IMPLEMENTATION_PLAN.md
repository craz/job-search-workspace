...
**R2.1.1:** **OWNER ACCEPTED · COMPLETE · PUSHED**.  
**R2.1.2:** **OWNER ACCEPTED · COMPLETE · PUSHED**.  
**R2.1.3:** **READY FOR OWNER ACCEPTANCE**. **R2.1.4+:** **NOT STARTED**.
...
| Phase | Focus | Status |
|---|---|---|
| **R2.1** | Local ResumeVersion / content snapshot of active HH resume | DECOMPOSITION **OWNER ACCEPTED**; R2.1.1–R2.1.2 **COMPLETE**; R2.1.3 **READY FOR OWNER ACCEPTANCE** |
...
**R2.1.1–R2.1.2 OWNER ACCEPTED · COMPLETE · PUSHED**.  
**R2.1.3 READY FOR OWNER ACCEPTANCE** (HH→Core manual sync).  
**R2.1.4+:** **NOT STARTED**.

Do not start R2.1.4 until owner ACCEPTs R2.1.3.
